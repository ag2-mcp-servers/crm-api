...
#   timestamp: 2025-06-28T14:42:32+00:00
...
class ActivitiesFilter(BaseModel):
    ...
    updated_since: Optional[datetime] = Field(
        None, examples=['2020-09-30T07:43:32.000Z'], title='Updated since (timestamp)'
    )
...
class CompaniesFilter(BaseModel):
    ...
    name: Optional[str] = Field(
        None, description='Name of the company to filter on', examples=['SpaceX']
    )
...
class ContactsFilter(BaseModel):
    ...
    email: Optional[str] = Field(
        ...
        examples=['elon@tesla.com'],
    )
    first_name: Optional[str] = Field(
        None, description='First name of the contact to filter on', examples=['Elon']
    )
    last_name: Optional[str] = Field(
        None, description='Last name of the contact to filter on', examples=['Musk']
    )
    name: Optional[str] = Field(
        None, description='Name of the contact to filter on', examples=['Elon Musk']
    )
...
class CrmWebhookEvent(BaseModel):
    ...
    event_type: Optional[CrmEventType] = None
...
class Note(BaseModel):
    ...
    company_id: Optional[str] = Field(None, examples=['12345'])
    contact_id: Optional[str] = Field(None, examples=['12345'])
    content: Optional[str] = Field(None, examples=['Office hours are 9AM-6PM'])
    created_at: Optional[str] = Field(None, examples=['2020-09-30T07:43:32.000Z'])
    created_by: Optional[str] = Field(None, examples=['12345'])
    id: Optional[str] = Field(None, examples=['12345'])
    lead_id: Optional[str] = Field(None, examples=['12345'])
    opportunity_id: Optional[str] = Field(None, examples=['12345'])
    owner_id: Optional[str] = Field(None, examples=['12345'])
    title: Optional[str] = Field(None, examples=['Meeting Notes'])
...
class OpportunitiesFilter(BaseModel):
    ...
    monetary_amount: Optional[float] = Field(
        None, description='Monetary amount to filter on', examples=[75000]
    )
    status: Optional[str] = Field(
        None, description='Status to filter on', examples=['Completed']
    )
    ...
    win_probability: Optional[float] = Field(
        None, description='Win probability to filter on', examples=[50]
    )
...
class Stage(BaseModel):
    ...
    display_order: Optional[int] = Field(None, examples=[1])
    id: Optional[str] = Field(None, examples=['contractsent'])
    name: Optional[str] = Field(None, examples=['Contract Sent'])
    value: Optional[str] = Field(None, examples=['CONTRACT_SENT'])
    win_probability: Optional[int] = Field(
        None,
...
class Pipeline(BaseModel):
    ...
    name: constr(min_length=1) = Field(..., examples=['Sales Pipeline'])
    ...
    win_probability_enabled: Optional[bool] = Field(None, examples=[True])
...
class UpdateActivityResponse(BaseModel):
    ...
    resource: str = Field(
        ..., description='Unified API resource name', examples=['activities']
    )
    service: str = Field(
...
class UpdateContactResponse(BaseModel):
    ...
    operation: str = Field(..., description='Operation performed', examples=['update'])
    resource: str = Field(
        ..., description='Unified API resource name', examples=['contacts']
    )
    service: str = Field(
        ..., description='Apideck ID of service provider', examples=['zoho-crm']
    )
...
class UpdateNoteResponse(BaseModel):
    ...
    operation: str = Field(..., description='Operation performed', examples=['update'])
    resource: str = Field(
        ..., description='Unified API resource name', examples=['notes']
    )
    service: str = Field(
        ..., description='Apideck ID of service provider', examples=['zoho-crm']
    )
...
class UpdateOpportunityResponse(BaseModel):
    data: UnifiedId
    operation: str = Field(..., description='Operation performed', examples=['update'])
    resource: str = Field(
        ..., description='Unified API resource name', examples=['companies']
...
class UpdatePipelineResponse(BaseModel):
    ...
    operation: str = Field(..., description='Operation performed', examples=['update'])
    resource: str = Field(
        ..., description='Unified API resource name', examples=['pipelines']
    )
    service: str = Field(
        ..., description='Apideck ID of service provider', examples=['zoho-crm']
    )
...
class CreateOpportunityResponse(BaseModel):
    ...
    operation: str = Field(..., description='Operation performed', examples=['add'])
    resource: str = Field(
        ..., description='Unified API resource name', examples=['opportunities']
    )
    service: str = Field(
        ..., description='Apideck ID of service provider', examples=['zoho-crm']
    )
...
class CreateUserResponse(BaseModel):
    ...
    operation: str = Field(..., description='Operation performed', examples=['add'])
    resource: str = Field(
        ..., description='Unified API resource name', examples=['users']
    )
    service: str = Field(
        ..., description='Apideck ID of service provider', examples=['zoho-crm']
    )
...
class User(BaseModel):
    ...
    created_at: Optional[str] = Field(None, examples=['2017-08-12T20:43:21.291Z'])
    ...
    id: Optional[str] = Field(None, examples=['12345'])
    image: Optional[str] = Field(
        None, examples=['https://logo.clearbit.com/spacex.com?s=128']
    )
    language: Optional[str] = Field(
        None,
        description='language code according to ISO 639-1. For the United States - EN',
    ...
    last_name: Optional[LastName] = None
    parent_id: Optional[str] = Field(None, examples=['54321'])
    password: Optional[str] = Field(None, examples=['supersecretpassword'])
    phone_numbers: Optional[List[PhoneNumber]] = None
    ...
    updated_at: Optional[str] = Field(None, examples=['2017-08-12T20:43:21.291Z'])
    username: Optional[str] = Field(None, examples=['masterofcoin'])
...
class Activity(BaseModel):
    ...
    account_id: Optional[str] = Field(None, examples=['12345'])
    activity_date: Optional[str] = Field(None, examples=['2021-05-01'])
    activity_datetime: Optional[str] = Field(
        None, examples=['2021-05-01T12:00:00.000Z']
    )
    all_day_event: Optional[bool] = Field(None, examples=[False])
    archived: Optional[bool] = Field(None, examples=[False])
    asset_id: Optional[str] = Field(None, examples=['12345'])
    attendees: Optional[List[ActivityAttendee]] = None
    campaign_id: Optional[str] = Field(None, examples=['12345'])
    case_id: Optional[str] = Field(None, examples=['12345'])
    child: Optional[bool] = Field(None, examples=[False])
    company_id: Optional[str] = Field(None, examples=['12345'])
    contact_id: Optional[str] = Field(None, examples=['12345'])
    contract_id: Optional[str] = Field(None, examples=['12345'])
    created_at: Optional[str] = Field(None, examples=['2020-09-30T07:43:32.000Z'])
    created_by: Optional[str] = Field(None, examples=['12345'])
    custom_fields: Optional[List[CustomField]] = None
    custom_object_id: Optional[str] = Field(None, examples=['12345'])
    deleted: Optional[bool] = Field(None, examples=[False])
    description: Optional[str] = Field(None, examples=['More info about the meeting'])
    ...
    duration_minutes: Optional[int] = Field(None, examples=[30])
    duration_seconds: Optional[conint(ge=0)] = Field(None, examples=[1800])
    end_date: Optional[str] = Field(None, examples=['2021-05-01'])
    end_datetime: Optional[str] = Field(None, examples=['2021-05-01T12:30:00.000Z'])
    event_sub_type: Optional[str] = Field(None, examples=['debrief'])
    group_event: Optional[bool] = Field(None, examples=[True])
    group_event_type: Optional[str] = Field(None, examples=['Proposed'])
    id: Optional[str] = Field(None, examples=['12345'])
    lead_id: Optional[str] = Field(None, examples=['12345'])
    location: Optional[str] = Field(None, examples=['Space'])
    location_address: Optional[Address] = None
    note: Optional[str] = Field(
        None, examples=['An internal note about the meeting'], title='Note (internal)'
    )
    opportunity_id: Optional[str] = Field(None, examples=['12345'])
    owner_id: Optional[str] = Field(None, examples=['12345'])
    private: Optional[bool] = Field(None, examples=[True])
    product_id: Optional[str] = Field(None, examples=['12345'])
    recurrent: Optional[bool] = Field(None, examples=[False])
    reminder_datetime: Optional[str] = Field(
        None, examples=['2021-05-01T17:00:00.000Z']
    )
    reminder_set: Optional[bool] = Field(None, examples=[False])
    show_as: Optional[ShowAs] = Field(None, examples=['busy'])
    solution_id: Optional[str] = Field(None, examples=['12345'])
    start_datetime: Optional[str] = Field(None, examples=['2021-05-01T12:00:00.000Z'])
    title: Optional[str] = Field(None, examples=['Meeting'])
    type: Type = Field(..., examples=['meeting'])
    updated_at: Optional[str] = Field(None, examples=['2020-09-30T07:43:32.000Z'])
    updated_by: Optional[str] = Field(None, examples=['12345'])
    user_id: Optional[str] = Field(None, examples=['12345'])
    video_conference_id: Optional[str] = Field(
        None, examples=['zoom:88120759396'], title='Meeting ID'
    )
    video_conference_url: Optional[str] = Field(
        None, examples=['https://us02web.zoom.us/j/88120759396'], title='Meeting URL'
    )
