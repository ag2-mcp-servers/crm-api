...
def activities_all(
    ...
    filter: Optional[ActivitiesFilter] = None,
...
def companies_all(
    ...
    cursor: Optional[str] = None,
    limit: Optional[conint(ge=1, le=200)] = 20,
    filter: Optional[CompaniesFilter] = None,
    sort: Optional[CompaniesSort] = None,
    fields: Optional[str] = None,
):
    """
    List companies
...
def contacts_all(
    ...
    cursor: Optional[str] = None,
    limit: Optional[conint(ge=1, le=200)] = 20,
    filter: Optional[ContactsFilter] = None,
...
def opportunities_all(
    ...
    cursor: Optional[str] = None,
    limit: Optional[conint(ge=1, le=200)] = 20,
    filter: Optional[OpportunitiesFilter] = None,
    sort: Optional[OpportunitiesSort] = None,
    fields: Optional[str] = None,
):
    """
    List opportunities
